namespace Mapbox.Examples
{
	...
	public class QuadTreeCameraMovement : MonoBehaviour
	{
		...
		[SerializeField] protected float _zoomSpeed = 0.25f;

		[SerializeField]
		public Camera _referenceCamera;

		[SerializeField] protected AbstractMap _mapManager;
		...
		protected Vector3 _mousePositionPrevious;
		protected bool _shouldDrag;
		protected bool _isInitialized = false;
		private Plane _groundPlane = new Plane(Vector3.up, 0);
		protected bool _dragStartedOnUI = false;
		...
		protected void HandleMouseAndKeyBoard()
		{
			// zoom
		...
		protected virtual void UseDegreeConversion()
		{
			if (Input.GetMouseButton(0) && !EventSystem.current.IsPointerOverGameObject())
			{
				var mousePosScreen = Input.mousePosition;
		...
		protected Vector3 GetGroundPlaneHitPoint(Ray ray)
		{
			float distance;
